...
resource "aws_iam_policy" "clusterautoscale" {
...
resource "aws_iam_role_policy_attachment" "policyattaching_clusterautoscaling" {
  policy_arn = "${aws_iam_policy.clusterautoscale.arn}"
  role       = aws_iam_role.example.name
}
